...
public class ProductInfoMCView extends JFrame {
   ...
   // ProductInfoMCView(ProductTable proTableModel) {
   //     throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    //}

	/**
	 * Create the frame.
     * @param proTableModdel
	 */
	public ProductInfoMCView( ProductTable proTableModdel) {

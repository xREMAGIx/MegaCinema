...
import MCControllers.BillIO;
import MCControllers.CustomerType;
import MCControllers.BillTable;
import MCControllers.CustomerList;
import MCControllers.CustomerTable;
import MCControllers.ProductTable;
...
//************************ Tab Product *************************		
		...
		panel_1 = new JPanel();
		tabbedPane.addTab("Vé", null, panel_1, null);
		...
		tblProduct.setModel((TableModel) proTableModel);
...
//****************************** Tab Bill *********************************************		
		...
		tblBill = new JTable();
		tblBill.setModel((TableModel) billTableModel);
...
//************************* Methods ***************************************
	...
	protected void addProduct() {
		new ProductInfoMCView(proTableModel).setVisible(true);
		
	}

	protected void addCustomer() {
		new CustomerInfoMCView(cusTableModel).setVisible(true);
	}
